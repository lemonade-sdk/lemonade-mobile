...
class _SheetScaffoldState extends State<SheetScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    // Lift the sheet above the keyboard and shrink its max height to the
    // remaining space so focused fields aren't hidden behind it.
          ...
          child: _Slide(
            child: Padding(
              ...
              child: Container(
                ...
                child: SafeArea(
                  top: false,
                  // Always-visible thumb: testers didn't realize sheet
                  // content (e.g. the plan list) continued below the fold.
                  child: Scrollbar(
                    controller: _scroll,
